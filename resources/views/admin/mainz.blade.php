...
<head>
    ...
    <!-- Bootstrap -->
    @vite(['resources/vendors/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet'])
    @vite(['/vendors/font-awesome/css/font-awesome.min.css'])
    @vite(['/vendors/nprogress/nprogress.css'])
    @vite(['/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css'])
    @vite(['/vendors/bootstrap-daterangepicker/daterangepicker.css'])
    @vite(['/build/css/custom.min.css'])
</head>
...
<body class="nav-md">
    ...
    <!-- jQuery -->
    @vite(['resources/vendors/jquery/dist/jquery.min.js'])
    @vite(['resources/vendors/bootstrap/dist/js/bootstrap.bundle.min.js'])
    @vite(['resources/vendors/fastclick/lib/fastclick.js'])
    @vite(['resources/vendors/nprogress/nprogress.js'])
    @vite(['resources/vendors/Chart.js/dist/Chart.min.js'])
    @vite(['resources/vendors/jquery-sparkline/dist/jquery.sparkline.min.js'])
    @vite(['resources/vendors/raphael/raphael.min.js'])
    @vite(['resources/vendors/morris.js/morris.min.js'])
    @vite(['resources/vendors/gauge.js/dist/gauge.min.js'])
    @vite(['resources/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js'])
    @vite(['resources/vendors/skycons/skycons.js'])
    @vite(['resources/vendors/Flot/jquery.flot.js'])
    @vite(['resources/vendors/Flot/jquery.flot.pie.js'])
    @vite(['resources/vendors/Flot/jquery.flot.time.js'])
    @vite(['resources/vendors/Flot/jquery.flot.stack.js'])
    @vite(['resources/vendors/Flot/jquery.flot.resize.js'])
    @vite(['resources/vendors/flot.orderbars/js/jquery.flot.orderBars.js'])
    @vite(['resources/vendors/flot-spline/js/jquery.flot.spline.min.js'])
    @vite(['resources/vendors/flot.curvedlines/curvedLines.js'])
    @vite(['resources/vendors/DateJS/build/date.js'])
    @vite(['resources/vendors/bootstrap-daterangepicker/daterangepicker.js'])
    @vite(['resources/build/js/custom.min.js'])
